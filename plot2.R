...
p2data <- cbind(timeformat, plotdata)
p2data$Global_active_power <- as.numeric(p2data$Global_active_power)

# Generate Plot 2
png(file = "plot2.png", width = 480, height = 480, units = "px")
plot(p2data$timeformat, p2data$Global_active_power, type = "l", xlab = "", ylab = "Global Active Power (kilowatts)")
dev.off()
